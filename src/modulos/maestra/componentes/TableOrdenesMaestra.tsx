...
import {
  ...
  type EditableFields,
} from "@/modulos/maestra/servicios/vistaMaestraService";

export function TableOrdenesMaestra() {
  ...
  const handleSaveRow = useCallback(
    // values tiene tipo Record<string, unknown> porque MRT_TableOptions.onEditingRowSave
    // no expone un generic más estricto para los valores del formulario de edición.
    async (row: MRT_Row<VistaMaestraTotalRow>, values: Record<string, unknown>) => {
      // Filtrar solo los campos editables
      const editableUpdates: Partial<EditableFields> = {
        observaciones: values.observaciones as string | null,
        notas_varias: values.notas_varias as string | null,
        prueba_estado_lab: values.prueba_estado_lab as string | null,
        estado_fact: values.estado_fact as string | null,
        estado_ot: values.estado_ot as string | null,
      };
