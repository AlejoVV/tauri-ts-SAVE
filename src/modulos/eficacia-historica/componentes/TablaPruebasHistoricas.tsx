...
import type { PruebaHistorica } from '@/modulos/eficacia-historica/tipos';
...
export function TablaPruebasHistoricas({ pruebas, cargando }: TablaPruebasHistoricasProps) {
                ...
                <tr key={`${prueba.fuente}-${prueba.numero_prueba}-${index}`} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-4 whitespace-nowrap">
                    <span className={cn(
                      ...
                      prueba.fuente === 'pruebas_anteriores' ? 'bg-green-100 text-green-800' : 'bg-purple-100 text-purple-800'
                    )}>
