...
} from "@/modulos/resumen/servicios/resumenService";
...
export function TableResumen() {
  ...
  const updateEstadoMutation = useMutation({
    mutationFn: async ({
      ...
      const result = await updateEstadoProceso(pruebaId, estadoProceso);
      if (!result.success) throw new Error(result.error ?? "Error al actualizar estado proceso");
    },
    onSuccess: () => {
