...
/**
 * Badge semántico: infiere el color a partir de palabras clave en el valor.
 * Usado en cabeceras de página donde el estado es texto libre de BD.
 */
...
/**
 * Badge con color fijo por tipo de columna de tabla.
 * Usado en WorkOrderTestsTable donde cada columna tiene un color asignado.
 */
