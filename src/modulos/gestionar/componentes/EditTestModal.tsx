...
export function EditTestModal({
  ...
  useEffect(() => {
    ...
    cargarDatos();
    // Setters y cargarDatosOT son estables por diseño; incluirlos causaría un loop de carga.
  ...
  const handleGuardar = async () => {
    ...
    const result = await actualizarPrueba(prueba.prueba_id, {
      ...
      dosisProducto: dosisRef.current?.value || null,
      ...
      fechaRecibido: date ? date.toISOString().split("T")[0] : null,
    });
