...
import { useFormularioRegistro } from "@/modulos/gestionar/hooks";
...
export function EditTestModal({
  ...
  useEffect(() => {
    ...
    cargarDatos();
    // `cargarDatosOT` y los setters del hook son estables por diseño (no cambian entre renders),
    // pero el linter no puede inferirlo sin verlos como primitivos. Incluirlos crearía
    // un loop de carga al mutar estado interno del hook en cada efecto.
